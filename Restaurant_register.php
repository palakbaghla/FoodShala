...
if (isset($register)) {
	...
	{
		$sql=mysqli_query($con,"insert into user() values()");
	...
	<div class="middle" style="margin: 0px auto; border:1px solid #F8F9FA; width: 800px">
		...
		<div class="tab-content" id="myTabContent">
			<div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="home-tab">
				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="name" value="<?php if(isset($r_name)){echo $r_name;}?>" placeholder="Enter the Restaurant Name" name="r_name" required/>
					</div>
					<div class="form-group">
			...
			<div class="tab-pane fade show" id="login" role="tabpanel" aria-labelledby="home-tab">
				<a href="Restaurant_login.php"><button type="button" style="padding:10px;  width:200px; margin-top:30%; margin-left:40%; margin:0px auto;" class="btn btn-outline-primary" name="login" value="Log In">Log In</button></a>
